...
const SYSTEM_PROMPT = [
  ...
  "comerciais ou financeiras; valores, custos ou desembolsos (inclusive a",
  "dimensão financeira do cronograma). Nada disso compete ao condomínio",
  "quando não afeta áreas comuns.",
  "",
  "Campos da resposta:",
