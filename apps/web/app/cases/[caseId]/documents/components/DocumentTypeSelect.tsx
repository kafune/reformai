...
export function DocumentTypeSelect({ value, onChange, disabled }: Props) {
  return (
    <select
      ...
      disabled={disabled}
      className="h-10 w-full rounded-sm border border-line-strong bg-surface px-3 text-sm text-ink-900 focus:outline-none focus:ring-2 focus:ring-green-400 disabled:opacity-50 max-md:min-h-11"
    >
